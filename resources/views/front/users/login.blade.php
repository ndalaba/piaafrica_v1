                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="contact-form">
                                ...
                                <p>Vous êtes à la recherche d'un emploi
                                    <a href="{{url('candidat/register')}}" class="col" style="font-weight: bold;color: #3ab795;">Créer un compte</a></p>

                                <p>Vous voulez enregistrer votre entreprise
                                    <a href="{{url('publier-entreprise')}}" class="col" style="font-weight: bold;color: #3ab795;">Inscrire votre entreprise</a></p>
