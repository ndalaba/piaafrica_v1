    ...
    <div class="header-search fixed-height">
        ...
        <div class="page-heading blog-list-heading">
            ...
            <div class="container">
                ...
                <h1>Offre d'emploi introuvable</h1>
                                ...
                                <div class="tab-pane active">
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-sm-4 col-xs-6">
                                            <p> L'annonce a été  supprimée ou n'existe plus </p>

                                            <p> Merci de votre confiance et à très bientôt sur {{ config('application.name') }} </p>

                                            <a href="{{ url('emploi') }}" title="Offre d'emploi en Afrique" class="btn btn-default">Retour à la page d'offres</a>
                                        </div>
                                    </div>
