        ...
        <div class="page-heading blog-list-heading">
            ...
            <div class="container">
                ...
                <div class="heading-link">
                    ...
                    <a href="{{ url('publier-entreprise') }}" title="Ajouter une entreprise à {{ config('application.name')}}">Inscription</a>
                </div>
                        ...
                        <div class="col-md-12">
                            <div class="contact-form">
                                ...
                                <form method="post" class="form-group" action="{{ url('reset-passeword') }}">
                                    ...
                                    <div class="form-input">
                                        <p><a href="{{ url('se-connecter') }}" style="font-weight: bold;color: #5F7A1B;margin-top: 10px;display: inline-block;margin-left: 20px;">Retour à la connexion</a></p>
                                    </div>
                                </form>
